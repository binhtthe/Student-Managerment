...
<html>
    <head>
        ...
        <script>
            ...
            function changePerPage() {
                ...
                window.location = "/ThachThatSchool/admin-classyearsemester-list?"
            ...
            function paging(container) {
                ...
                if (pageId - gap > 1) {
                    $("#" + container).append(
                            "<a class='navigator' href=/ThachThatSchool/admin-classyearsemester-list"
                ...
                for (let i = pageId - gap; i <= pageId ; i++) {
                    if (i > 0) {
                        $("#" + container).append(
                                "<a id = \"" + i + "\" href=/ThachThatSchool/admin-classyearsemester-list"
    ...
    <body onload="paging('paging');activePage()">
        ...
        <section class="right">
            ...
            <form action="/ThachThatSchool/admin-classyearsemester-list" method="POST">
                    ...
                    <c:forEach items="${requestScope.classyearsemesters}" var="cys">
                        <tr>
                            ...
                            <td>
                                ...
                                |  <a href="/ThachThatSchool/admin-classyearsemester-update?classCode=${cys.classroom.classCode}&year=${cys.year}&semester=${cys.semester}&teacherCode=${cys.homeroomTeacher.teacherCode}">
                                    Edit
                                </a>
                            </td>
                            <td>
                                <a href="/ThachThatSchool/admin-classyearsemester-schedule?classCode=${cys.classroom.classCode}&year=${cys.year}&semester=${cys.semester}&startDate=${cys.startDate}&endDate=${cys.endDate}">
                                    Edit
                                </a>
                            </td>
                        </tr>
