    ...
    <head>
        ...
        <script>
            ...
            function doUpdate(teacherCode) {
                window.location = "/ThachThatSchool/admin-teacher-update?teacherCode=" + teacherCode;
            }
            ...
            function doDelete(teacherCode) {
                ...
                if (check) {
                    $.ajax({
                        url: "/ThachThatSchool/admin-teacher-delete",
                        type: 'GET',
                        data: {
            ...
            function paging(){
                ...
                if(currentPage - gap > 1){
                    $("#paging").append(
                        "<a id='1' href=/ThachThatSchool/admin-teacher-list?query="+query
                ...
                for(let i = currentPage - gap ; i <= currentPage ; i++){
                    if(i >= 1){
                        $("#paging").append(
                          "<a id='"+ i +"' href=/ThachThatSchool/admin-teacher-list?query="+query
                ...
                if(currentPage + gap < totalPage){
                    $("#paging").append(
                        "<a id='"+ totalPage +"' href=/ThachThatSchool/admin-teacher-list?query="+query
            ...
            function changePerPage() {
                ...
                var query = $("#query").val();
                var totalsearchedteachers = $("#totalSearchedTeachers").val();
                window.location = "/ThachThatSchool/admin-teacher-list?"
    ...
    <body onload="paging();activePage()">
        ...
        <jsp:include page="../header.jsp"></jsp:include>
            <section class="right">
                ...
                <form action="/ThachThatSchool/admin-teacher-list" method="POST">
