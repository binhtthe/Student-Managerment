    ...
    <head>
        ...
        <script>
            function doChange() {
                var year = $("#year").val();
                var week = $("#week").val();
                window.location = "/ThachThatSchool/teacher-schedule?year=" + year + "&week=" + week;
            }

            function takeAttendance(scheduleindex) {
                window.location = "/ThachThatSchool/teacher-schedule-attendance?scheduleindex=" + scheduleindex;
            }
        </script>
    </head>
    <body>
