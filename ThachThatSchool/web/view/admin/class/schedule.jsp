    ...
    <head>
        ...
        <script>
            function doChange() {
                ...
                window.location = "/ThachThatSchool/admin-classyearsemester-schedule?year=" + year + "&weekNumber=" + week
            ...
            function doDelete(str, stt) {
                ...
                if (check) {
                    ...
                    var classCode = $("#classCode").val();
                    $.ajax({
                        url: '/ThachThatSchool/admin-classyearsemester-schedule-delete',
                        type: 'POST',
                        data: {
                            day: day,
                            slot: slot,
            ...
            function doInsert(str) {
                ...
                var weekNumber = $("#week").val();
                 window.location = "/ThachThatSchool/admin-classyearsemester-schedule-add?year=" + year + "&day=" +
            ...
            function doUpdate(str) {
                ...
                var endDate = $("#endDate").val();
                var weekNumber = $("#week").val();
                window.location = "/ThachThatSchool/admin-classyearsemester-schedule-update?year=" + year + "&day=" +
