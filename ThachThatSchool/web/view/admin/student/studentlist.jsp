...
<html>
    <head>
        ...
        <script>
            ...
            function doConfirm(studentCode) {
                ...
                if (phone.length == 0 || phone.match("[0-9]{10}")) {
                    if (check) {
                        ...
                        $.ajax({
                            url: "/ThachThatSchool/admin-student-list",
                            type: "PUT",
            ...
            function doDelete(value) {
                ...
                if (check) {
                    $.ajax({
                        url: "/ThachThatSchool/admin-student-list?studentCode=" + studentCode + "&username=" + username,
                        type: 'DELETE',
                        success: function (response) {
            ...
            function doTakeClass(studentCode) {
                window.location = "/ThachThatSchool/admin-student-class-add?studentCode=" + studentCode;
            }
    ...
    <body onload="activePage()">
        ...
        <section class="right">
            <form action="/ThachThatSchool/admin-student-list" method="POST">
            ...
            <div>
                <c:forEach begin="1" end="${requestScope.totalPage}" var="page">
                    <a id="${page}" 
                       href="/ThachThatSchool/admin-student-list?pageId=${page}&query=${requestScope.query}&totalsearchedstudents=${requestScope.totalsearchedstudents}">
                        ${page}
                    </a>
                </c:forEach>
            </div>
