    ...
    <head>
        ...
        <script>
            ...
            function doEdit(str) {
                ...
                window.location = "/ThachThatSchool/student-mark-update?classindex=" + classindex + "&studentindex=" + studentindex
            ...
            function doDelete(no) {
                ...
                if (checked) {
                    $.ajax({
                       url : "/ThachThatSchool/student-mark-delete",
                       type : 'POST',
                       data : {
                           no : no,
            ...
            function doInsert() {
                ...
                $.ajax({
                    url: "/ThachThatSchool/student-mark",
                    type: 'POST',
                    data: {
                        studentindex: studentIndex,
